<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Consultation_Request.aspx.cs" Inherits="Benchkart.Consultant.Consultation_Request" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <div style="padding: 30px;">
                <table width="90%">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlStatus" runat="server" OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged" AutoPostBack="true" class="form-control">
                                <asp:ListItem Value="1">New</asp:ListItem>
                                <asp:ListItem Value="2">Follow Up</asp:ListItem>
                                <asp:ListItem Value="3">Closed</asp:ListItem>
                                <asp:ListItem Value="4">Spam</asp:ListItem>
                                <asp:ListItem Value="5">Not Reachable</asp:ListItem>
                                <asp:ListItem Value="6">Escalate For Assistance</asp:ListItem>
                                <asp:ListItem Value="7">Requirement Not Clear</asp:ListItem>
                                <asp:ListItem Value="8">Project Created</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td>
                            <asp:TextBox runat="server" class="form-control" ID="txtContactNumber" ValidationGroup="Search"
                                Placeholder="Contact Number" Style="width: 60%; marbtnsearch_click gin: 0 auto; float: right;"></asp:TextBox>
        ...
        <div>
            <asp:Repeater ID="rptConsult" runat="server" OnItemDataBound="RepeaterItemCreated">
                <HeaderTemplate>
                    <table id="tblRequests" class="footable" border="0">
                        <thead>
                            <tr>
                                <th style="display: table-cell;">Consult Id
                                </th>
                                <th style="display: table-cell;">Name
                                </th>
                                <th style="display: table-cell;">Email
                                </th>
                                <th style="display: table-cell;">Contact Number
                                </th>
                                <th style="display: table-cell;">Contact Preference
                                </th>
                                ...
                                <th style="display: table-cell;">Status
                                </th>
                            </tr>
                        </thead>
                </HeaderTemplate>
                <ItemTemplate>
                    <tbody>
                        <tr>
                            <td>
                                <asp:Label ID="lblConsultId" runat="server" Text='<%#Eval("ConsultId")%>'></asp:Label>
                            </td>
                            <td>
                                <%#Eval("Name")%>
                            </td>
                            ...
                            <td>
                                <%#Eval("PreferredContactMethod").ToString() == "1" ? "Call" : "Email" %>
                            </td>
                            <td>
                                <%#Eval("CompanyName")%>
                            </td>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlStatusChange" runat="server" SelectedValue='<%# Eval("Status") %>' OnSelectedIndexChanged="ddlStatusChange_SelectedIndexChanged" AutoPostBack="true" class="form-control">
                                    <asp:ListItem Value="1">New</asp:ListItem>
                                    <asp:ListItem Value="2">Follow Up</asp:ListItem>
                                    <asp:ListItem Value="3">Closed</asp:ListItem>
                                    <asp:ListItem Value="4">Spam</asp:ListItem>
