<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Partners.aspx.cs" Inherits="Benchkart.Admin.Partners" %>
            ...
            <ItemTemplate>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <asp:HyperLink ID="hplViewDetail" Text="View Detail..." runat="server" NavigateUrl='<%# String.Format("~/Admin/Partner_Details.aspx?id={0}", DataBinder.Eval(Container.DataItem, "PartnerId")) %>'>           
                            </asp:HyperLink>
                        </td>
                    </tr>
                </tbody>
