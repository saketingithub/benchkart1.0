<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customers.aspx.cs" Inherits="Benchkart.Admin.Customers" %>
                ...
                <ItemTemplate>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <asp:HyperLink ID="hplViewDetail" Text="View Detail..." runat="server" NavigateUrl='<%# String.Format("~/Admin/Customer_Details.aspx?id={0}", DataBinder.Eval(Container.DataItem, "CustomerId")) %>'>           
                                </asp:HyperLink>
                            </td>
                        </tr>
                    </tbody>
