<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Requests.aspx.cs" Inherits="Benchkart.Admin.Requests" %>
...
<body>
    ...
    <div style="font-size: 20px; font-weight: bold; color: Black; height: 60px; background-color: White;
        margin-top: 0px;">
        ...
        <div style="float: right; margin-top: 20px;">
            <asp:Label runat="server" ID="lblConsultantEmail" CssClass="label" ForeColor="Gray"
                Style="padding: 20px;"></asp:Label></div>
    </div>
    <%--<div class="container">
    ...
    <div style="background-color: #1d4354;">
        <div style="padding: 30px;">
            <table width="100%">
                <tr>
                    <td >
                        <asp:DropDownList runat="server" ID="ddlRequestStatus" 
                            class="form-control" AutoPostBack="true" Style=" margin: 0 auto;" OnSelectedIndexChanged="ddlRequestStatus_SelectedIndexChanged">
                            <asp:ListItem Value="1" Selected="True">New Request</asp:ListItem>
            ...
            <ItemTemplate>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <%#(Eval("OutsourceType").ToString() == "1") ?"Consult" : (Eval("OutsourceType").ToString() == "2") ? "Customer" :(Eval("OutsourceType").ToString() == "3") ? "Project":"" %>
                        </td>
                        <td>
                            <%#Eval("CreationDate")%>
                        </td>
                        <td>
                            <asp:HyperLink ID="hplViewDetail" Text="View Detail..." runat="server" NavigateUrl='<%# String.Format("~/Admin/Request_Details.aspx?id={0}", DataBinder.Eval(Container.DataItem, "RequestId")) %>'
                                >           
                            </asp:HyperLink>
                        </td>
                    </tr>
