<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgetPassword.aspx.cs" Inherits="Benchkart.Partner.ForgetPassword" %>
...
<head id="Head1" runat="server">
    ...
    <title>Partner - Forget Password</title>
                        ...
                        <asp:Panel ID="pnlOtp" runat="server" DefaultButton="btnEmailIdGenrateOtp" class="panel" Style="margin: 0 auto; width: 50%;">
                            ...
                            <div>
                                <asp:TextBox runat="server" ID="txtEmailidForgetPassword" class="form-control"
                                     PlaceHolder="Enter Email Id" Style="margin-top: 10px;"></asp:TextBox>

                            </div>
                            <div class="formindent">
                                <asp:Button ID="btnEmailIdGenrateOtp" style="margin-top: 20px;" runat="server" OnClick="btnEmailIdGenrateOtp_Click" OnClientClick="return checkemail()" CssClass="button" Text="Generate OTP" />
                            </div>
                        </asp:Panel>
                        <asp:Panel ID="pnlForgetPassword" Style="display: none;" runat="server" DefaultButton="btnSave" CssClass="panel">
                            <div>
                                <asp:TextBox runat="server" ID="txtOtp" class="form-control"
                                     PlaceHolder="Verify OTP code"></asp:TextBox>
                            </div>

                            <div>
                                <asp:TextBox ID="txtForgetPassword" runat="server" TextMode="Password" Style="margin-top: 20px;"
                                    CssClass="form-control fa-step-forward" placeholder="New Password"></asp:TextBox>
                            </div>
                            <div>
                                <asp:TextBox ID="txtCForgetPassword" runat="server" TextMode="Password" Style="margin-top: 20px; margin-bottom: 30px;"
                                    CssClass="form-control " placeholder="Confirm password"></asp:TextBox>
                            </div>
                            <div class="formindent">
                                <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" OnClientClick="return checkpassword();" CssClass="button" Text="Submit" />
                            </div>
