<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DigitalTransformation.aspx.cs" Inherits="Benchkart.DigitalTransformation" %>
...
<head>
    ...
    <link href="assetscovid/css/StyleDT.css" rel="stylesheet">
</head>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
                        <h3>Strategies for the New Normal</h3>
                        <p class="font-italic">
                           We are amidst unprecedented business environment. This, more than ever, is the time to choose wisely. 
                        </p>
                        The Benchkart platform sees hundreds of companies employ innovative strategies and undertake projects based on those strategies. Our framework is based on the trend in the kind of projects that companies undertook. Companies undertook projects based on how they perceived the short term & long term impact of the post-pandemic world. We call this the "New Normal Framework".
                        </p>
                        </p>
                        For adoption of this framework, companies must analyse which block they are in, based on the Near-term Impact (High, Low) & Long-term impact (High, Low) of the pandemic. We recommend 4 strategies depending on which block they are in".
                        </p>
                        <p class="'font-italic"> E.g. If you believe that although the near term pandemic impact is highly negative (due to travel restrictions & social distancing requirements) but the long term pandemic impact is low negative or positive, your strategy should be to "Conserve".</p>
                    </div>
                </div>
        ...
        <section id="features" class="features">
            <div class="container" data-aos="fade-up">
                <div class="row">
                    ...
                    <div class="image col-lg-6" style='background-image: url("assetscovid/img/new normal.jpg");' data-aos="fade-right"></div>
                    <div class="col-lg-6" data-aos="fade-left" data-aos-delay="100">
                         <h4>Once you have analysed which block best represents your business, we recommend you 4 digital strategies for the new normal </h4><br />
                        <ul>
        ...
        <section id="cta" class="cta">
            <div class="container" data-aos="zoom-in">
                ...
                <div class="text-center">
                    ...
                    <p>Find & work with the Right Agency for the Right Price. Get India’s finest agencies across IT Services & Digital Marketing to work for you.</p>
