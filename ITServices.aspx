<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ITServices.aspx.cs" Inherits="Benchkart.ITServices" %>
...
<head>
    ...
    <title>Find India's Top IT Services Providers at one place.</title>
    <meta content="Save Time & Money on your IT Services Outsourcing. Use Benchkart to Engage with Top IT Services agencies for your IT Projects." name="description">
    <meta content="IT Outsourcing,  B2B Marketplace,  IT Services, Hire Agency, Hire Developers, website Development, Mobile App Development, IT Projects, IT Consulting , ERP Implementation, CRM Implementation" name="keywords">
    ...
    <link href="assetscovid/css/StyleIT.css" rel="stylesheet">
</head>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
                <div class="col-xl-6 col-lg-8">
                    ...
                    <h2>Websites| Apps| Software| ERP| Cloud</h2>
                </div>
            </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
                        <img src="assetscovid/img/Partner Awards1.jpg" class="img-fluid" alt="" />

                    </div>
                    <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
                        <h3>We work with industry experts</h3>
                        <p class="font-italic">
                            Benchkart partners are reputed for the quality of work they do. They bring domain expertise and boast of prestigious global clients & awards. This helps us provide you with:
                        </p>
                        <ul>
                            <li><i class="ri-check-double-line"></i><b>Choice</b>: Every IT Project is different. There can be different requirements of technology or framework, understanding of industry or scenario for which the solution is required or even APIs/ Licenses which have to integrated. At Benchkart, the availability of hundreds of service providers organized by their detailed profiles and our expert algorithm & human support help you zone in on the right agency for you. </li>
                            <li><i class="ri-check-double-line"></i><b>Speed</b>: Search & discovery of IT service providers, especially, if done through referrals, internet searches etc take too much time. The ability to therefore get multiple qualifies proposals within 48-72 hours adds speed to your IT initiatives. There are many organizations who post every single IT project in their company on Benchkart! This helps them be more agile & shortens their time to market</li>
                            <li><i class="ri-check-double-line"></i><b>Reliability</b>: Digital Transformation is critical for growth in this era. The choice of an IT partner is now more critical than ever. The right agency for you should have the required skillsets to deliver projects, the professionalism to manage timelines, and the infrastructure to provide support during and after the project.</li>                     
                        </ul>
                        <p class="font-italic">
                            Do write to outsource@benchkart.com to learn more about how your company can adopt Benchkart and have hundreds of agencies across IT Services at your fingertips.
                        </p>
                    </div>
                </div>
        ...
        <section id="features" class="features">
            <div class="container" data-aos="fade-up">
                <div class="row">
                    ...
                    <div class="image col-lg-6" style='background-image: url("assetscovid/img/Form-min.jpg");' data-aos="fade-right"></div>
                    <div class="col-lg-6" data-aos="fade-left" data-aos-delay="100">
                         <h4>Hundreds of customers, from start-ups to MNCs are on Benchkart now!</h4>
                        <p class="font-italic">A look at the kind of projects which are trending:
                        </p><br />
                        <div class="icon-box mt-5 mt-lg-0" data-aos="zoom-in" data-aos-delay="150">
                            <i class="bx bx-receipt"></i>
                            <h4>Websites & E-commerce Portals</h4>
                            <p>Basic Wordpress websites; hyperlocal grocery sites; dynamic travel sites with Amadeus integration & CRM, job-portals, online coaching classes, premium wellness center websites, B2B websites.</p>
                        </div>
                        <div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
                            <i class="bx bx-cube-alt"></i>
                            <h4>iOS & Android Applications</h4>
                            <p>Kids learning apps, sales-force order-taking & biometric attendance apps, contactless dining experience apps, fantasy sports & online gaming apps, automated channel rewards programmes, service delivery applications.</p>
                        </div>
                        <div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
                            <i class="bx bx-images"></i>
                            <h4>Custom Software Development</h4>
                            <p>Automated MIS Dashboards, E-learning modules, Integrated pharmacy & healthcare module, Retail Investor education & transaction platform, GST Invoicing, E-commerce Partner payout automation, HR Tech Web applications.</p>
                        </div>
                        <div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
                            <i class="bx bx-shield"></i>
                            <h4>Hiring Developers</h4>
                            <p>Short term (3-6 months) hire of developers across technologies like Android Kotlin, IOS Swift, Angular JS/ React JS, Java Springboot, ASP.Net, Oracle ADF esp in experience band of 3-6 years. </p>
                        </div>
                        <div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
                            <i class="bx bx-receipt"></i>
                            <h4>Cloud, ERP, CRM & More</h4>
                            <p>SME implementation of ERP like SAP B1 or MS Dynamics, Custom & packaged CRM, Migration of IT Infrastructure to cloud, Email migration, integrated IoT software development. </p>
                        </div>
                    </div>
                </div>
   ...
   <%--     <section id="portfolio" class="portfolio">
        ...
        <section id="cta" class="cta">
            <div class="container" data-aos="zoom-in">
                ...
                <div class="text-center">
                    <h3>Benchkart Case Studies</h3>
                    <p>"If history were taught in the form of stories, it would never be forgotten!" <br /> We too have some interesting Case Studies from the projects on Benchkart</p>
                    <a class="cta-btn" href="/CaseStudy.aspx">Learn More</a>
                </div>
